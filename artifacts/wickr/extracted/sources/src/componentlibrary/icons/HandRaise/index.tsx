...
export const HandRaiseIcon: React.FC<HandRaiseProps> = ({ isRaised, ...rest }) => {
  return (
    <Svg {...rest}>
      {isRaised && <circle fill="var(--colors-primary-main)" id="Circle" cx="12" cy="12" r="10" />}
      <path
